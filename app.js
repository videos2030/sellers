...
export const DICT = {
  ...
  'modal.bidNotice':   { ar: 'بإرسالك هذه المزايدة، فإنك توافق على أنه في حال قبولها سيصلك بريد يوضح التكلفة النهائية التي يحددها الموديل، وأن ٢٠٪ من هذا المبلغ مستحقة مقدماً بعملة XRP (شبكة XRP Ripple - XRPTag) قبل بدء العمل. الباقي يُتفق عليه مباشرة مع الموديل.', en: 'By submitting, you acknowledge that if this bid is accepted, the site will email you the final total cost the talent charges, and that 20% of that amount is due upfront in XRP ( XRP Ripple - XRPTag) before work begins. The remaining balance is arranged directly with the talent.' },
